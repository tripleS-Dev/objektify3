...
def simple(temp_id, cache_id=None, input_image_raw=None, input_image=None, simple_components=None, others=None, true=None, false=None, demo=None, tabs=None, download_share_buttons=None, raws = None, download_bar = None):
